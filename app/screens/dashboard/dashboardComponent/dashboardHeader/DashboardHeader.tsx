        ...
        <Card.Content>
          <View style={styles.container}>
            ...
            <View style={styles.textContainer}>
              <Text variant="bodyLarge">{getTranslationLabel('welcome')}</Text>
              <View style={styles.titleSecondContainer}>
                <Text variant="titleLarge">{userData?.lasUserName}</Text>
              </View>

              <Text variant="bodySmall">{`${getTranslationLabel('las_id')}: ${
                userData?.lasId
              }`}</Text>
            </View>
